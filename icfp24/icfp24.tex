...
\paragraph{Set-theoretc mode support negatived types}
...
\paragraph{Concusions of this paper}
...
This paper shows how \anon{Luau} pragmatic model is defined,
and how it supports benefits of pragmic models.

\section{Semantic subtyping for \anon{Luau}}
...
In this presentation, we presect the minimal core of \anon{Luau},
which supports scalars and functions. This presentation ingores
tables, mutable features, and object obects.
...
\[
S, T ::= b \mid \UNKNOWN \mid \NEVER \mid S \fun T \mid S \cap T \mid S \cup T
\]
which are:
\begin{itemize}
...
\item the \emph{anything type} $\UNKNOWN$,
...
\subsection{Co- and contra-variance of subtyping for fuctions}
...
\subsection{Distritution of intersection and union over fuctions}

Finally, we turn to cases where intersection and union disturiute
