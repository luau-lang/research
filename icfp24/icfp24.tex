...
\begin{proof}
  ...
  \item $\UNKNOWN$: Not a case, since finction types.
  \item $s$: Not a case, since scalares are not function types.
  ...
  \item $S \cup T$: By indiction we have normalized function types,
    and by Lemma~\ref{lem:xxx} normalized function types support union.
  \end{itemize}
\end{proof}
